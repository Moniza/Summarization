...
/**
 * There is only one method that is to be used 
 * 
 */
...
class PorterStemmer {
	...
	/*String Clean(String str) { 
		String returnable = str.replaceAll("[^A-Za-z0-9] ", " ");
		return returnable; 
		}
	*/
	String Clean(String str) {
...
//		System.out.println(stem("This is a test of porters stemmer. Computation computerized"));
	}
